from diffusion.diff_wrapper import DynaSTI_PEMSBAY
...
import matplotlib
from datasets.dataset_pemsbay import get_dataloader
...
mean_std_file = f'{folder}/pemsbay'
...
train_loader, test_loader = get_dataloader(mean_std_file, n_features, batch_size=2, missing_ratio=0.02, simple=simple, is_neighbor=is_neighbor, spatial_choice=spatial_choice, is_separate=is_separate)
...
filename = f"model_dynasti_pemsbay.pth"
print(f"\nDynaSTI training starts.....\n")
model_folder = 'saved_models_pemsbay'
...
data_folder = f"results_pemsbay/data"
