            ...
            for j, test_batch in enumerate(it, start=1):
                ...
                if 'PriSTI' in models.keys():
                    with torch.no_grad():
                        ...
                        samples_pristi, c_target_pristi, eval_points_pristi, observed_points_pristi, _, _, _, _ = output_pristi
