...
filename = f"model_dynasti_fft_metrla{'_no_se' if no_se else ''}{'_no_te' if no_te else ''}.pth"
...
# Define the file path where the EMA model is saved
ema_model_filepath = f"{model_folder}/ema_model_fft_metrla{'_no_se' if no_se else ''}{'_no_te' if no_te else ''}.pth"
